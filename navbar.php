  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
        <ul class="nav"  style="height:100%;">
            <li>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img alt="Brand" src="http://www.esportes.co/img/icone.png" style="width: 40px;">
