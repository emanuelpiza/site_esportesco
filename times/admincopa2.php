                ...
                <div class="row-fluid">
                    <div class="span12">
                        <table class="table">
                            ...
                            $stmt->execute();
                                // The "back" link
                            $prevlink = ($data > $min) ? '<a href="?key='.$key.'&data=' . $last . '#class_partidas" title="Previous page"><span style="color:black; margin-right:14px; margin-top:0px; font-size:17px; "><i class="fa fa-caret-left" aria-hidden="true" style="color:white;"></i></span></a>' : '<span style="color:white; margin-right:14px; margin-top:10px; font-size:17px; "><i class="fa fa-caret-left" style="color:white;" aria-hidden="true"></i></span>';

                            // The "forward" link
                            $nextlink = ($data < $max) ? '<a href="?key='.$key.'&data=' . $next . '#class_partidas" title="Next page"><span style="color:black; margin-left:15px; margin-top:0px; font-size:17px; "><i class="fa fa-caret-right" aria-hidden="true" style="color:white;"></i></span></a>' : '<span style="color:white; margin-left:15px; margin-top:10px; font-size:17px; "><i class="fa fa-caret-right" style="color:white;" aria-hidden="true"></i></span>';
