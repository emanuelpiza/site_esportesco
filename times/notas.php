...
<head>
    ...
    <title>Arbitragem - <?php echo $dados['name']; ?> - EsportesCo</title>
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Times</h3>
                <a href="../cadastro/time.php?key=<?php echo $key; ?>"><button class="btn btn-xs btn-success" style="float:right;">Adicionar Time</button></a>
            </div><!-- /.box-header -->
