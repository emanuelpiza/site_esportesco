...
<head>
  ...
  <title>Campeonato Criado - Copa Metropolitana 2017</title>
            ...
            <td align="center" valign="top">
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            ...
                            <br>
                             O link abaixo possui a chave de acesso ao Painel Administrativo. Compartilhe esse endereço apenas com outros administradores.
                            <br>
                            <br>
                            </td>
                          </tr>
                    ...
                    <td>
                      <div><!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          ...
                          <center>
                        <![endif]-->
                            <a href="http://www.esportes.co/times/admincopa.php?key=<?php echo $key; ?>"
                      style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Painel Administrativo</a>
                        <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
                    ...
                    <center>
                      <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                        <tr>
                          ...
                          <br>
                          <br>
                            <span style="color:#ffffff;">Campeonato: 00<?php echo $id; ?></span> <br>
                            Abril, 2017
                          </td>
                        </tr>
                      </table>
                ...
                <table style="margin: 0 auto; width:100%;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#414141" style="margin: 0 auto">
                  <tr>
                    ...
                    <br><a href="https://www.facebook.com/Esportes-Co-295544220637495/" target="_blank">
                      facebook</a>
                      <br>
                    </td>
                  </tr>
