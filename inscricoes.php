...
<html lang="en">
    <head>
        <title><?php echo $name ?> - Inscrições EsportesCo</title>
        <?php 
                    ...
                    <div class="row">
                        <?php 
                            ...
                            if ($expiration_date > $today) { 
                                echo '
                                <h1 class="headline super hairline" style="text-align:center; margin-bottom:40px;">Inscrições Abertas</h1>
                    <h1 class="countdown hyper hairline" data-date="'.$date.' 00:00:00">
                     ...
                     <div class="col-md-12  text-default">
                            <div class="text-center">
                                <a href="../cadastro/time.php?id='.$copa.'" class="btn btn-danger btn-lg text-center btn-icon-right" target="_self">Inscrever meu time
                                    <span class="hex-alt">
                                ...
                                echo ' <h1 class="headline super hairline" style="text-align:center; margin-bottom:40px;">Inscrições Encerradas</h1>
                                 <div class="col-md-12  text-default">
                                    <div class="text-center">
                                        <a href="times/copa.php?id='.$copa.'" class="btn btn-danger btn-lg text-center btn-icon-right" target="_self">Acompanhar Campeonato
                                            <span class="hex-alt">
